...
public final class Inventory {
    ...
    void addPandaMission(PandaMission mission){
        inventoryPandaMission.add(mission);
    }

    void addParcelMission(ParcelMission mission){
        inventoryParcelMission.add(mission);
    }

    void addPeasantMission(PeasantMission mission){
        inventoryPeasantMission.add(mission);
    }

    void subPandaMissions(List<PandaMission> pandaMissions){
        inventoryPandaMission.removeAll(pandaMissions);
    }

    void subParcelMissions(List<ParcelMission> parcelMissions){
        inventoryParcelMission.removeAll(parcelMissions);
    }

    void subPeasantMissions(List<PeasantMission> peasantMissions){
